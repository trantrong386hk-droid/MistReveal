...
class TextGenerationService {
    ...
    【环境调温规则】
    若用户生于秋季（农历7-9月，金旺）或冬季（农历10-12月，水旺），画像背景必须强制加入暖调元素以抵消命理寒气：
    - 秋生者 → 背景加入「暖金色夕阳光」「琥珀色余晖」「温暖的侧逆光」
    - 冬生者 → 背景加入「壁炉火光」「暖黄灯光」「晨曦暖阳」
    禁止给秋冬生人配置冷蓝色、银灰色、雪景等加重寒气的背景。
    ...
    当夫/妻星为七杀（偏官）时：
    → 伴侣样貌偏向"坚定且有保护欲"：眼神深沉但带温情、轮廓清晰但不凌厉、眉宇间有英气但不压迫、身姿挺拔从容
    → 不要写成柔弱无力的样貌，但也不要过于冷硬逼人
    ...
    private func generateForbiddenWords(xiYongShen: String) -> String {
        ...
        case "木":
            ...
            ✅ 必须使用：自然健康、白里透红、松绿色、林间光影、温润、有生命力、舒展、光影斑驳、清新、蓬勃
            """
        case "火":
            return """
